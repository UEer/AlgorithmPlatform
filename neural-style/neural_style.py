...
def neural_sytle(content, styles, output, **kwargs):
    parser = build_parser()
    arguments = ['--content', content, '--styles', styles, '--output', output]
    ...
    for iteration, image in stylize(
        ...
        if iteration is not None:
            if options.checkpoint_output:
                output_file = options.checkpoint_output % iterationj
        else:
...
if __name__ == '__main__':
    neural_sytle('./s.jpg', './examples/c.jpg', './s.output.jpg', width="300")
